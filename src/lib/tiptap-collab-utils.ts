...
import { isNodeSelection, isTextSelection, posToDOMRect } from '@tiptap/vue-3'
...
/**
 * Map of node type names to their display labels
 */
...
/**
 * Checks if the current selection is valid for editing
 * @param editor - The editor instance
 * @param selection - Optional selection to check (defaults to current selection)
 * @param excludedNodeTypes - Node types to exclude from validation
