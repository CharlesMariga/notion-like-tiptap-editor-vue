...
/**
 * Gets the node and position at the anchor point of the selection
 * @param editor - The Tiptap editor instance
 * @param allowEmptySelection - Whether to allow empty selections (default: true)
 * @returns Object containing the node and position, or null if not found
 */
...
/**
 * Gets the selected DOM element from the editor selection
 * @param editor - The Tiptap editor instance
