...
export interface SuggestionMenuProps<T = DefaultContext>
  extends Omit<SuggestionOptions<T>, "pluginKey" | "editor"> {
  /**
   ...
   * Optional - can use default slot instead.
   */
  children?: (props: SuggestionMenuRenderProps<T>) => VNode;
}
