...
export function useCodeBlock(config?: UseCodeBlockConfig) {
  ...
  const canToggleState = ref(canToggle(editor.value))
  const isActive = ref(editor.value?.isActive('codeBlock') || false)
  ...
  watch(
    ...
    (newEditor) => {
      ...
      const handleSelectionUpdate = () => {
        ...
        canToggleState.value = canToggle(newEditor)
        isActive.value = newEditor.isActive('codeBlock')
      }
